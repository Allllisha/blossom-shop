                    ...
                    <div className="pdp-howto-steps">
                      ...
                      <div className="pdp-howto-step">
                        ...
                        <div>
                          ...
                          <p>Tune in to our TikTok live at <a href="https://www.tiktok.com/@sakurasakusquishy" target="_blank" rel="noopener noreferrer">@sakurasakusquishy</a> and keep the items you love in your basket.</p>
                        </div>
                      </div>
                      <div className="pdp-howto-step">
